...
public class DBUser {
	...
	public String toString() {
		return "DBUser [id=" + id + ", pwd=" + pwd + ", name=" + name + ", email=" + email + ", birth=" + birth
				+ ", sns=" + sns + ", reg_date=" + reg_date + "]";
	}
	
	public DBUser(String id, String pwd, String name, String email, Date birth, String sns, Date reg_date) {
		super();
		this.id = id;
		this.pwd = pwd;
		this.name = name;
