...
<c:set var = "mypageLink" value="${sessionScope.id==null? '':''}"/>
...
<c:set var = "LoginOutlinkMypage" value="${sessionScope.id==null? '/BCsignup':'/login/logout'}"/>
<c:set var = "LoginMypage" value="${sessionScope.id==null? '회원가입':''}"/>
<c:set var = "myPagePwd" value="${sessionScope.pwd==null? '/myPage/myPage_v1':'/myPage/myPage_v1_2'}"/>
...
@font-face {
    font-family: 'Miwon';
    src: url('resources/font/Miwon.woff') format('woff'),
        url('resources/font/Miwon.woff2') format('woff2');
    font-weight: bold;
    font-style: normal;
    font-display: swap;
    }
   ...
   .main{
    ...
    .b_noticebgcolor{
    	background-color: rgba(252, 150, 150, 0.3);
    }
    .b_readcontent{
...
<body>
            ...
            <div class="search" style="text-align: center;">
                ...
                <div class="mypageDiv">
                    <ul class="mypage">
                        ...
                        <li><a href="<c:url value='/board/list_v1_2'/>">여행일지</a></li>
                    </ul>
                </div>
            </div>
            <div class ="nav">
                <div id="column">
                    <div class="city">
                        <h2><a id="select" href="<c:url value='${mypageLink}'/>">개인정보</a></h2>
                    </div>
                    <div class="city">
                        <h2><a href="<c:url value='/myPage/myPage_v1_3'/>">예약/취소 내역</a></h2>
                    </div>
                    <div class="city">
                        <h2><a href="<c:url value='/myPage/myPage_v1_4'/>">찜 목록</a></h2>
                    </div>
                    <div class="city">
                        <h2><a href="<c:url value='/myPage/myPage_v1_5'/>">고객문의</a></h2>
                    </div>
                </div>
                <div class="column2">
                    <div>
                    	${session.name }님의 개인정보
                    </div>
                    <div>
                    	<h1>회원탈퇴</h1>
                    </div>
	...
	<script>
		let msg = "${msg}";
		if(msg == "del") alert("삭제되었습니다.");
		if(msg == "error") alert("삭제실패.");
	</script>
</body>
</html>