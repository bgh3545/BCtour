...
.form_container_pwd>div>input[type="tel"] {
	width: 230px;
	font-size: 1.5em;
	padding: 10px;
	margin-right: 20px;
...
<body>
	<header>
		<div>
			<a href="<c:url value='/'/>"><img src="/ch1/resources/img/로고.jpg"
				width="200px" alt="로고"></a>
		</div>
		<div>
			<a href="<c:url value='/BClogin/BClogin'/>"><img
				src="/ch1/resources/img/로그인.png" width="110px" alt="로그인"></a>
		</div>
	</header>
	<div id="vertical">
		<div>
