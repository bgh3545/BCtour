...
<body>
   <div class="main">
        ...
        <div class="search">
            ...
            <div id="mypage">
                <a href="<c:url value='${MyPageLink }'/>">${MyPage}</a>
                <a id="select" href="<c:url value='/board/list'/>">여행일지</a>
            </div>
        </div>
        <div class ="nav">
            <div class="column">
                <a href="<c:url value='/board/list'/>"><h2 id="select">게시판1</h2></a>
                <a href="<c:url value='/board/list1'/>"><h2>게시판2</h2></a>
                <a href="<c:url value='/board/list2'/>"><h2>게시판3</h2></a>
            </div>
            <div class="column2">
                <div class="imgContainer">게시판1</div>
            </div>
            <div id="empty">
