            ...
            <div class="search" style="text-align: center;">
                ...
                <div class="mypageDiv">
                    <ul class="mypage">
                        ...
                        <li><a id="select" href="<c:url value='/board/list_v1_2'/>">여행일지</a></li>
                    </ul>
                </div>
            </div>
            <div class ="nav">
                    ...
                    <div class="b_content">
                    	...
                    	<c:forEach var="i" items="${notice}">
	                    	...
	                    	<div class="b_indextitle b_noticebgcolor">
	                    		...
	                    		<div class="b_rcontentNum">&nbsp</div>
                    	...
                    	<form action="<c:url value='/board/list_v1_2'/>" class="b_searchform" method="post">
