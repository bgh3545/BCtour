        ...
        <div class="allDiv">
            ...
            <div class ="product_div">
                <div class="pic_and_list">
                    ...
                    <input id="input-submit" type="submit" value="이미지 올리기"></input>
                </div>
                <div class ="pd_info">
                    <div class="pd_infoTable">
                        <table class="tour_desc">
                            <tbody class="t_desc_tbl">
                                ...
                                <td style="padding-bottom: 0;">
                                    ...
                                    <div class="deportDepart">
                                        <div class="deport">
                                                <dt>출발 : <input type="text" name="pd_departStart" placeholder="출발시간"></dt>
                                                <dt>도착 : <input type="text" name="pd_departEnd" placeholder="도착시간"></dt>
                                        </div>
                                        <div class="depart">
                                            <p>출발 : <input type="text" name="pd_deportStart" placeholder="출발시간"></p>
                                            <p>도착 : <input type="text" name="pd_deportEnd" placeholder="도착시간"></p>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="pd_city1" placeholder="도시1">-> 
                                    <input type="text" name="pd_reserveUntil" placeholder="도시2"> -> 
                                    <input type="text" name="pd_city3" placeholder="도시3">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <div class ="pd_titleDiv">
                        <div class="pd_title">
                            ...
                            <input class ="pd_titleInput" type="text" name="pd_text" placeholder="#...">
                            <input class ="pd_titleInput" type="text" name="pd_days" placeholder="숙박일">
                        </div>
                    </div>
                </div>
                <input id="input-submit" type="submit" value="등록"></input>
                <
            </div>
            </form>
        </div>
